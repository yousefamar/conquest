var CONQUEST = {
	...
	main: function () {
		...
		// TODO: Consider creating Sprite class with render method.
		CONQUEST.Settler.prototype.sprite = { sheet: CONQUEST.textures.spritesheet, x: 0, y: 0, w: 16, h: 16 };
		CONQUEST.Tree.prototype.sprite = { sheet: CONQUEST.textures.spritesheet, x: 32, y: 32, w: 32, h: 32 };
		CONQUEST.Barrel.prototype.sprite = { sheet: CONQUEST.textures.spritesheet, x: 64, y: 32, w: 32, h: 32 };
		CONQUEST.House.prototype.sprites = [
			{ sheet: CONQUEST.textures.spritesheet, x: 96, y: 32, w: 32, h: 32 },
			{ sheet: CONQUEST.textures.spritesheet, x: 96, y: 64, w: 32, h: 32 },
			{ sheet: CONQUEST.textures.spritesheet, x: 96, y: 96, w: 32, h: 32 },
			{ sheet: CONQUEST.textures.spritesheet, x: 96, y: 128, w: 32, h: 32 }
		];
		CONQUEST.House.prototype.sprite = CONQUEST.House.prototype.sprites[0];
